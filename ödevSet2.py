...
#
#
# İsim : Ahmet yasin Büyükçelik
# Ortak çalışanlar : Yok
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while True:
        if calculate_handlen(hand) == 0:
            ...
            break
        print()
        print('Mevcut El:', end=' '), display_hand(hand)
        user_input = str.lower(input('Kelime veya Bitirdiğinizi belirtmek için "!!" girin: '))
        if user_input == '!!':
            ...
            if is_valid_word(user_input, hand, word_list):
                ...
                print('"%s"' % user_input, current_word_score, 'puan kazandı. Toplam:', total_score, 'puan')
            else:
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    sub_count = 1
    replay_count = 1
    num_hands = int(input('Toplam el sayısını girin: '))
    TOTAL = 0
    while num_hands >= 1:
        new_score = 0
        ...
        while sub_count >= 1:
            print()
            print('Mevcut el:', end=' '), display_hand(hand)
            sub_option = input('Bir harfi değiştirmek ister misiniz? ')
        ...
        while replay_count >= 1:
            print('----------')
            replay_option = input('Elini tekrar oynatmak ister misin? ')
    ...
    print('----------')
    print('Tüm ellerde toplam puan: ', TOTAL)
